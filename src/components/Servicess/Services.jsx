      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-10 mt-10 ">
        {servicelist.map((service, idx) => (
          <motion.div
            ...
            className="md:p-12 bgMain p-6 rounded-3xl space-y-2 md:space-y-4 shadow-sm shadow-[#ffffff] active:shadow-none  hover:-translate-y-3 active:-translate-y-3 duration-500 transition-all"
          >
